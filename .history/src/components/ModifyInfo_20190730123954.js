...
let cos = e.target.disabled;
 cos = true;
  ...
  const setName = () => {
    const value = document.querySelector('.nameChange')
  }
  ...
  return (
    ...
    <div key={plant.id}  className="modal">
      ...
      <div className="change__name">
        ...
        <button className="change__name__btn" onClick={()=> setName(".change__name")}>SET NAME</button>
      </div>
      ...
      <div className="change__desc">
        ...
        <button className="change__desc__btn">SET DESCRIPTION</button>
      </div>
