...
if(show && ident === plant.id ){
  return (
    ...
    <div key={plant.id}  className="modal">
      ...
      <div>{plant.name}</div>
      <button className="modal__p__chan onClick={()=> {setChangeVisible(".change__name"); setChangeVisible('.modalhide')}}>Change</button>
      ...
      <div className="change__name">
        ...
        <button className="modal__button" onClick={()=> changeName(plant)}>SET NAME</button>
      </div>
      </div>
      ...
      <div className="change__desc">
        ...
        <button className="modal__button" onClick={()=> changeDesc(plant)}>SET DESCRIPTION</button>
      </div>
      </div>
      <p className="modal__p">Plant irrigation</p>
      <input placeholder={plant.irrigation} onChange={(e) => setValue(e.target.value)}></input>
      <button className="modal__button" onClick={(e) => setIntervall(e,plant.id,'irrigation')}>Start period (minute)</button>
      <p className="modal__p">Plant fertilization</p>
      <input placeholder={plant.fertilization}></input>
      <button className="modal__button" onClick={(e) => setIntervall(e,plant.id,'fertilization')}>Start period (minute)</button>
      <p className="modal__p">Plant weeding</p>
      <input placeholder={plant.weeding}></input>
      <button className="modal__button" onClick={(e) => setIntervall(e,plant.id,'weeding')}>Start period (minute)</button>
