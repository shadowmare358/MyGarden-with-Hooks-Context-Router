  ...
  return (
    ...
    <div key={plant.id}  className="modal">
      ...
      <div className="change__name">
        ...
        <input className="nameChange" type="name" placeholder={plant.name} onChange={(e) => setName(e.target.value)} required></input>
      ...
      <div className="change__desc">
        ...
        <input className="descChange" type="desc" placeholder={plant.desc} onChange={(e) => setDesc(e.target.value)}  required></input>
