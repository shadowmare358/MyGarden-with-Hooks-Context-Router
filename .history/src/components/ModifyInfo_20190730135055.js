  ...
  return (
    ...
    <div key={plant.id}  className="modal">
      ...
      <div className="change__name">
        ...
        <span className="closeBtn" onClick={()=> setChangeVisible(".change__name")}>X</span>
        <input className="nameChange"></input>
        <button className="change__name__btn" onClick={()=> {setName(plant); setChangeVisible('.modalhide')}}>SET NAME</button>
      </div>
      </div>
      ...
      <div className="change__desc">
        ...
        <span className="closeBtn" onClick={()=> setChangeVisible(".change__desc")}>X</span>
