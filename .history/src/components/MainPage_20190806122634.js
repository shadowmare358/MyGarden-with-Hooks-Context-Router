        ...
        <div className="mainPage">
          ...
          <ul className="mainList">
             {garden.map((plant,index) => {
              ...
              <button className="mainList_delBtn">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio fuga, libero odit ullam voluptatem enim perferendis dolores pariatur sit porro eius sapiente commodi laborum. Voluptatum repudiandae sunt numquam? Fugit commodi voluptatibus neque rem quae eos eligendi architecto aspernatur doloribus labore velit officiis voluptatum maxime quam fuga, officia sequi amet quidem.Delete</button>
              </div>
