...
const NewPlantForm = () => {
    ...
    return (
        <form className="addPage" onSubmit={handleSubmit}>
            ...
            <input className="addPage_input-type-file" type="file" accept="file/*"/>
            <input className="addPage_input-type-submit" type="submit" value="Add plant" onChange={(e) => setImage(URL.createObjectURL(event.target.files[0]))}/>
