        ...
        <div className="mainPage">
          ...
          <ul className="mainList">
             {garden.map((plant,index) => {
              ...
              <button className="mainList_delBtn">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore velit obcaecati itaque iste praesentium sapiente quos libero, saepe neque in ea provident fugit ut. Ducimus illo tenetur aspernatur at, sit soluta inventore, possimus fuga modi beatae reiciendis rem nihil, perspiciatis laudantium eaque debitis dicta aut repudiandae voluptas? Minima, quo repudiandae!Delete</button>
              </div>
