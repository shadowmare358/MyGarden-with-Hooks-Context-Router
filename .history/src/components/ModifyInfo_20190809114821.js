...
if(show && ident === plant.id ){
  return (
    ...
    <div key={plant.id}  className="modal">
      ...
      <button className="modal__button" onClick={(e) => setIntervall(e,plant.id,'irrigation')}>Start period (days)</button>
      <p className="modal__p">Plant fertilization</p>
      <input placeholder={plant.fertilization}></input>
      <button className="modal__button" onClick={(e) => setIntervall(e,plant.id,'fertilization')}>Start period (days)</button>
      <p className="modal__p">Plant weeding</p>
      <input placeholder={plant.weeding}></input>
      <button className="modal__button" onClick={(e) => setIntervall(e,plant.id,'weeding')}>Start period (days)</button>
